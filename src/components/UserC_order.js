...
class UserC_order_detail extends Component {
    constructor(props) {
      super(props);
      this.state = {
        name:"",
     ...
     //   訂單列表
      fetch('http://localhost/foodstory_end/PHP-and-SQL-master/php/user_orders/user_orders_API.php', {
        method: 'GET',
        mode:'cors',
        credentials: 'include',
        body: JSON.stringify(),
...
export default UserC_order_detail;